...
import { getProducts, getCategoryProducts, getCategory, getSettings, getFeaturedProducts } from '../services/cartService';
...
export default function Products() {
  ...
  const pageTitle = category?.name || (searchQuery ? `Hasil Pencarian: "${searchQuery}"` : 'Produk');
  const pageDescription = category?.description || (searchQuery ? `Menampilkan hasil pencarian untuk "${searchQuery}"` : 'Koleksi produk kami. Temukan produk terbaik dengan harga terjangkau.');
    ...
    <div className="shop-theme flex flex-col pb-20">
      ...
      <div className="section-header p-4">
        <div>
          ...
          <div className="section-subtitle">{pageDescription}</div>
        </div>
      </div>

      {/* <nav className="shop-container pt-6">
        <div className="flex items-center gap-2 text-sm mb-6">
          ...
          {slug ? (
            <>
              ...
              <span className="text-gray-900 font-medium truncate max-w-[200px]">{category?.name}</span>
            </>
          ) : (
      ...
      {settings && (
        <>
              ...
              <div className="shop-info">
                ...
                <div className="shop-stats">
                  <div className="shop-stat">
                    <strong>{products.length || featured.length}</strong>
                    <span>Produk</span>
                  </div>
                  {[
          ...
          <div className="shop-tabs-wrapper p-4">
            <div className="shop-tabs-wrapper-inner">
              ...
              {!loading && (
                <ProductFilter onFilterChange={handleFilterChange} className="border-0 bg-transparent p-0 mb-0" />
              )}
            </div>
          </div>
        </>
      ...
      <nav className="bottom-nav">
        ...
        <Link to="/produk" className="bottom-item active">
          <svg viewBox="0 0 24 24" className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
