  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content={`Hubungi ${settings?.store_name || 'kami'} untuk informasi lebih lanjut. Telepon, WhatsApp, email, dan alamat toko.`} />
      </Helmet>
      ...
      <section className="bg-gradient-to-br from-primary-800 via-primary-700 to-primary-900 text-white py-16">
        <div className="max-w-5xl mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-3">Kontak Kami</h1>
      ...
      <div className="max-w-5xl mx-auto px-4 -mt-8 relative z-10 pb-16">
        ...
        {settings?.store_maps_embed && (
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 mb-8 overflow-hidden hover:shadow-md transition-shadow duration-200">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {/* Contact Info */}
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 lg:p-8 hover:shadow-md transition-shadow duration-200">
            ...
            <div className="space-y-4">
              ...
              {settings?.store_address && (
                <div className="flex items-start gap-4 p-4 bg-gray-50/50 rounded-xl hover:bg-primary-50/50 transition-all duration-200 group">
                  <div className="w-12 h-12 bg-white rounded-xl flex items-center justify-center flex-shrink-0 shadow-sm group-hover:shadow-md transition-all">
                    <svg className="w-5 h-5 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                    </svg>
              ...
              {settings?.store_whatsapp && (
                <div className="flex items-start gap-4 p-4 bg-gradient-to-br from-success-50/50 to-white rounded-xl border border-success-100/50 hover:border-success-200 hover:shadow-md transition-all duration-200 group">
                  <div className="w-12 h-12 bg-white rounded-xl flex items-center justify-center flex-shrink-0 shadow-sm group-hover:shadow-md transition-all">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center justify-center gap-2 bg-success-500 text-white px-5 py-2.5 rounded-xl text-sm font-bold hover:bg-success-600 transition-all duration-200 shadow-md hover:shadow-lg hover:shadow-success-500/30"
                      >
            ...
            {banks.length === 0 ? (
              ...
              <div className="space-y-4">
                {banks.map((bank, index) => (
                  <div key={bank.id || index} className="border border-gray-100 rounded-xl p-5 hover:border-primary-100 hover:shadow-sm transition-all duration-200">
