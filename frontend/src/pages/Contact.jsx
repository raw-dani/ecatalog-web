    ...
    <div className="shop-theme flex flex-col pb-20">
      ...
      <nav className="shop-container pt-6" style={{ paddingBottom: 0 }}>
        <div className="flex items-center gap-2 text-sm mb-6">
          ...
          <span className="text-gray-900 font-medium">Kontak Kami</span>
        </div>
      </nav>
      ...
      <section className="shop-container">
        <div className="section-header">
          <div>
            ...
            <div className="section-subtitle">Kami siap membantu Anda melalui berbagai saluran komunikasi</div>
          </div>
        </div>
        ...
        {settings?.store_maps_embed && (
          <div className="mb-8 bg-white border border-gray-100 rounded-lg overflow-hidden hover:shadow-md transition-all duration-200">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
          <div className="bg-white border border-gray-100 rounded-lg p-5 md:p-6 hover:shadow-md hover:border-gray-200 transition-all duration-200">
            ...
            <div className="space-y-3">
              {settings?.store_address && (
                <div className="flex items-start gap-3 p-4 bg-gray-50/50 rounded-lg hover:bg-primary-50/50 transition-all duration-200">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="font-semibold text-gray-900 leading-relaxed text-sm">{settings.store_address}</p>
                  </div>
                </div>
              )}
              ...
              {settings?.store_phone && (
                <div className="flex items-start gap-3 p-4 bg-gray-50/50 rounded-lg hover:bg-primary-50/50 transition-all duration-200">
                  ...
                  <div className="flex-1">
                    ...
                    <a href={`tel:${settings.store_phone}`} className="font-semibold text-gray-900 hover:text-primary-600 transition-colors text-sm">
                      {settings.store_phone}
                    </a>
                  </div>
                </div>
              ...
              {settings?.store_whatsapp && (
                <div className="flex items-start gap-3 p-4 bg-success-50/50 rounded-lg border border-success-100/50 hover:border-success-200 hover:shadow-sm transition-all duration-200">
                  <div className="w-10 h-10 bg-white rounded-lg flex items-center justify-center flex-shrink-0 shadow-sm">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                      <span className="font-semibold text-gray-900 text-sm">{settings.store_whatsapp}</span>
                      <a
                        href={`https://wa.me/${settings.store_whatsapp}`}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center justify-center gap-2 bg-success-500 !text-white px-4 py-2 rounded-lg text-sm font-semibold hover:bg-success-600 transition-colors"
                      >
              ...
              {settings?.store_email && (
                <div className="flex items-start gap-3 p-4 bg-gray-50/50 rounded-lg hover:bg-primary-50/50 transition-all duration-200">
                  ...
                  <div className="flex-1">
                    ...
                    <a href={`mailto:${settings.store_email}`} className="font-semibold text-gray-900 hover:text-primary-600 transition-colors text-sm">
                      {settings.store_email}
                    </a>
                  </div>
                </div>
          ...
          <div className="bg-white border border-gray-100 rounded-lg p-5 md:p-6 hover:shadow-md hover:border-gray-200 transition-all duration-200">
            <div className="flex items-center gap-3 mb-5 pb-4 border-b border-gray-100">
              <div className="w-10 h-10 bg-primary-50 rounded-lg flex items-center justify-center">
                <span className="text-primary-600"><BankSvgIcon className="w-5 h-5" /></span>
              </div>
            ...
            {banks.length === 0 ? (
              <div className="text-center py-10">
                <div className="w-14 h-14 bg-gray-50 rounded-lg flex items-center justify-center mx-auto mb-3">
                  <BankSvgIcon className="w-7 h-7 text-gray-400" />
                </div>
                <p className="text-gray-500 font-medium text-sm">Belum ada rekening yang terdaftar.</p>
                <p className="text-gray-400 text-xs mt-1">Segera hubungi kami untuk informasi pembayaran.</p>
              </div>
            ) : (
              <div className="space-y-3">
                {banks.map((bank, index) => (
                  <div key={bank.id || index} className="border border-gray-100 rounded-lg p-4 hover:border-gray-200 hover:shadow-sm transition-all duration-200">
