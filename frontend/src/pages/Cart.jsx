  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Lihat dan kelola keranjang belanja Anda." />
      </Helmet>
      ...
      <div className="max-w-5xl mx-auto px-4 py-12">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          {items.length > 0 && (
            <button
              onClick={clearCart}
              className="flex items-center gap-1.5 text-sm text-danger-600 hover:text-danger-700 bg-danger-50 hover:bg-danger-100 px-3 py-1.5 rounded-lg transition-colors"
            >
        ...
        {settingsError && (
          <div className="bg-danger-100 text-danger-700 p-4 rounded-lg mb-6 text-center">
            {settingsError}
          </div>
        )}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-4">
              {items.map((item, index) => {
                ...
                return (
                  <div key={item.id || index} className="bg-white rounded-xl shadow-sm border border-gray-100 p-4 hover:shadow-md transition-shadow duration-200">
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 sticky top-24">
                ...
                <Link
                  to="/produk"
                  className="w-full flex items-center justify-center gap-2 mt-3 py-2.5 border border-gray-200 rounded-xl text-sm font-medium text-gray-600 hover:bg-gray-50 hover:border-gray-300 transition-all duration-200"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
