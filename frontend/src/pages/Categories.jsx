  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Jelajahi semua kategori produk kami. Temukan produk terbaik dengan kualitas dan harga terjangkau." />
      </Helmet>
      ...
      <section className="bg-gradient-to-br from-primary-800 via-primary-700 to-primary-900 text-white overflow-hidden relative">
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-20 md:py-28 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Kategori Produk</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 -mt-8 relative z-10">
        {categories.length === 0 ? (
          <div className="text-center py-20">
            ...
            <Link
              to="/produk"
              className="inline-flex items-center gap-2 bg-primary-600 text-white px-8 py-3 rounded-xl font-semibold hover:bg-primary-700 transition-all duration-200 shadow-md hover:shadow-lg"
            >
          ...
          <>
            {/* Category Stats */}
            <div className="flex items-center justify-between mb-8 bg-white rounded-2xl shadow-sm border border-gray-100 px-6 py-4">
              ...
              {categories.map(category => {
                ...
                return (
                  <Link
                    ...
                    className="group bg-white rounded-2xl shadow-sm border border-gray-100 p-6 text-center hover:shadow-lg hover:border-primary-100 hover:-translate-y-1 transition-all duration-300"
                  >
                    {/* Image or Icon */}
                    ...
                    {category.products_count !== undefined && category.products_count !== null && (
                      <div className="inline-flex items-center gap-1 text-xs text-gray-400 bg-gray-50 group-hover:bg-primary-50 group-hover:text-primary-500 px-3 py-1 rounded-full transition-colors">
